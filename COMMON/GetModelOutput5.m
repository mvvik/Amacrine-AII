...
%
%  Generate capacitance vs pulse duration data for a sensor with 5 binding sites
%  ------------------------------------------------------------------------------
...
%  ACC       = ODE solver tolerance (should be small for ode15s, e.g. 1e-5)
	...
	kp1 = 5*kp;        kp2 = 4*kp;      kp3 = 3*kp; kp4 = 2*kp;      kp5 = kp;          % Binding rates of 5 stages
    km1 = km/(coop^2); km2 = 2*km/coop; km3 = 3*km; km4 = 4*km*coop; km5 = 5*km*coop^2; % Unbinding rates of 5 stages
