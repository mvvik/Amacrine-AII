...
% Generate capacitance vs. pulse duration curves shown in Fig. 4C
% These curves will be used for fitting the exocytosis model (Figs. 5 & S4)
% Below are parameters for bi-exponential fits to curves in Fig. 4C
    ...
    % Approximation to the errors for the 3 conditions, as shown in Fig. 4C
