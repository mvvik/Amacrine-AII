...
%
%  Generate capacitance vs pulse duration data for a sensor with 2 binding sites
%  ------------------------------------------------------------------------------
...
%  ACC       = ODE solver tolerance (should be small for ode15s, e.g. 1e-5)
    ...
    kp1   = 2*kp;     kp2 = kp;                   % Binding rates of individual stages
    km1   = km/coop;  km2 = 2*km*coop;            % Unbiding rates of individual stages
